		...
		<div class="head">
			<div class="header container">
				<div class="logo col-md-2 container-fluid">
					<a href="<?php echo bloginfo('url')?>" title="<?php echo get_bloginfo ( 'description' );?>"><img class="logo img-responsive img-responsive" src="<?php echo get_option('theme_Lenmo_Logo')?>"></a>
				</div>
				<div class="nav col-md-7" id="menu">
					<ul> <?php echo strip_tags(wp_nav_menu( $menu)); ?></ul>
				</div>
				<div class="search col-md-3">
					<form action="">
						<input type="text">
						<button title="搜索"><i class="fa fa-search falg"></i></button>
					</form>
				</div>
			</div>
			</div>
